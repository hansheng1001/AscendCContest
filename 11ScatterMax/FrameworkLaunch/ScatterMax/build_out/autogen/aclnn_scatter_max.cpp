...
SupportInfo list0_3 = {inputDesc0_3, 3, outputDesc0_3, 1};
...
[[maybe_unused]] uint32_t NNOPBASE_ScatterMax = 0U;
} // namespace
    ...
    aclOpExecutor **executor)
{
    ...
    static NnopbaseDfxId tilingId = {0x60000, "aclnnScatterMaxTiling", false};
    void *nnopExecutor;
    static void *executorSpace = NULL;
    const char *opType = "ScatterMax";
    char inputDesc[] = {1, 1, 1};
    char outputDesc[] = {1};
    char attrDesc[] = {0};

    NNOPBASE_ASSERT_NOTNULL_RETVAL(xRef);
    ...
    *executor = reinterpret_cast<aclOpExecutor *>(nnopExecutor);
    ...
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddInput(*executor, xRef, 0));
    ...
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddOutput(*executor, xRef, 0));
