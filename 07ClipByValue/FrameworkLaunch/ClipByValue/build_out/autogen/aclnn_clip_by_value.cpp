...
SupportInfo list0_2 = {inputDesc0_2, 3, outputDesc0_2, 1};
SupportInfo supportInfo0[3] = {list0_0, list0_1, list0_2};
OpSocSupportInfo socSupportInfo0= {supportInfo0, 3};

OpSocSupportInfo opSocSupportList[1] = {socSupportInfo0};
OpSupportList supportList = {opSocSupportList, 1};

[[maybe_unused]] uint32_t NNOPBASE_ClipByValue = 0U;
} // namespace
    ...
    aclOpExecutor **executor)
{
    ...
    static NnopbaseDfxId tilingId = {0x60000, "aclnnClipByValueTiling", false};
    void *nnopExecutor;
    static void *executorSpace = NULL;
    const char *opType = "ClipByValue";
    char inputDesc[] = {1, 1, 1};
    char outputDesc[] = {1};
    char attrDesc[] = {};

    NNOPBASE_ASSERT_NOTNULL_RETVAL(x);
    NNOPBASE_ASSERT_NOTNULL_RETVAL(minv);
    NNOPBASE_ASSERT_NOTNULL_RETVAL(maxv);
    ...
    *executor = reinterpret_cast<aclOpExecutor *>(nnopExecutor);
    ...
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddInput(*executor, minv, 1));
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddInput(*executor, maxv, 2));
