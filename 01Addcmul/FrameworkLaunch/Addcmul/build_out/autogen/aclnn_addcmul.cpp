...
[[maybe_unused]] uint32_t NNOPBASE_Addcmul = 0U;
} // namespace
    ...
    aclOpExecutor **executor)
{
    ...
    static NnopbaseDfxId tilingId = {0x60000, "aclnnAddcmulTiling", false};
    void *nnopExecutor;
    static void *executorSpace = NULL;
    const char *opType = "Addcmul";
    char inputDesc[] = {1, 1, 1, 1};
    char outputDesc[] = {1};
    char attrDesc[] = {};

    NNOPBASE_ASSERT_NOTNULL_RETVAL(value);
    NNOPBASE_ASSERT_NOTNULL_RETVAL(inputData);
    ...
    *executor = reinterpret_cast<aclOpExecutor *>(nnopExecutor);
    ...
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddInput(*executor, value, 0));
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddInput(*executor, inputData, 1));
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddInput(*executor, x1, 2));
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddInput(*executor, x2, 3));
