...
1.op_statistic.csv:AI Core and AI CPU operator calling times and time consumption.
...
2.op_summary.csv:AI Core, AI CPU, AI Vector and Hccl communication operator data,is used to collect statistics on operator details and time consumptions.
...
3.task_time.csv:Task Scheduler summary.
...
4.api_statistic.csv:Time spent by AscendCL API, is used to collect statistics on the time spent by API execution at the CANN layer.
