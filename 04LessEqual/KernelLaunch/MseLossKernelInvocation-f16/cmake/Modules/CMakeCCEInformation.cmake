...
set(CMAKE_STATIC_LIBRARY_CREATE_CCE_FLAGS "--cce-build-static-lib")
set(CMAKE_LIBRARY_CREATE_CCE_FLAGS "--cce-fatobj-link")
...
if(NOT CMAKE_CCE_CREATE_STATIC_LIBRARY)
  set(CMAKE_CCE_CREATE_STATIC_LIBRARY
      "<CMAKE_CCE_COMPILER> ${CMAKE_LIBRARY_CREATE_CCE_FLAGS} <CMAKE_SHARED_LIBRARY_CCE_FLAGS> <LANGUAGE_COMPILE_FLAGS> <LINK_FLAGS> <CMAKE_STATIC_LIBRARY_CREATE_CCE_FLAGS> <SONAME_FLAG><TARGET_SONAME> -o <TARGET> <OBJECTS>")
endif()
