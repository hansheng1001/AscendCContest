...
{
    size_t fileSize = 0;
    ReadFile("../input/input_predict.bin", fileSize, runner.GetInputBuffer<void>(0), runner.GetInputSize(0));
    ReadFile("../input/input_label.bin", fileSize, runner.GetInputBuffer<void>(1), runner.GetInputSize(1));
    ReadFile("../input/input_dout.bin", fileSize, runner.GetInputBuffer<void>(2), runner.GetInputSize(2));
