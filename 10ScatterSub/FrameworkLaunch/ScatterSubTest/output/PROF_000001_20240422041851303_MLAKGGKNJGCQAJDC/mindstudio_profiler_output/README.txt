...
3.op_summary.csv:AI Core, AI CPU, AI Vector and Hccl communication operator data,is used to collect statistics on operator details and time consumptions.
