...
#if 0
extern "C" __global__ __aicore__ void scatter_sub(GM_ADDR x, GM_ADDR index, GM_ADDR update, GM_ADDR x_ref, GM_ADDR workspace, GM_ADDR tiling) {
...
extern "C" __global__ __aicore__ void scatter_sub(GM_ADDR x, GM_ADDR index,
  ...
  op.Init(
      x, index, update, x_ref, tiling_data.dataType, tiling_data.indexLength,
...
void scatter_sub_do(uint32_t blockDim, void *l2ctrl, void *stream, GM_ADDR x,
  ...
  scatter_sub<<<blockDim, l2ctrl, stream>>>(x, index, update, x_ref, workspace,
                                            tiling);
