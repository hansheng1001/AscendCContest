...
if(DEFINED ASCEND_PRODUCT_TYPE)
    ...
    elseif(ASCEND_PRODUCT_TYPE AND NOT ASCEND_PRODUCT_TYPE MATCHES "^Ascend[0-9][0-9][0-9][a-zA-Z]?[1-9]?$")
        message(FATAL_ERROR
            ...
            "is not one of the following: Ascend910A, Ascend310P1, Ascend910B1, Ascend310B1"
        )
    elseif(ASCEND_PRODUCT_TYPE STREQUAL "Ascend910A")
    ...
    elseif(ASCEND_PRODUCT_TYPE STREQUAL "Ascend310P1")
        if (ASCEND_CORE_TYPE STREQUAL "AiCore")
    ...
    elseif(ASCEND_PRODUCT_TYPE STREQUAL "Ascend310B1")
        if (ASCEND_CORE_TYPE STREQUAL "AiCore")
            set(_CMAKE_COMPILE_AS_CCE_FLAG "--cce-aicore-arch=dav-m300")
        elseif(ASCEND_CORE_TYPE STREQUAL "VectorCore")
            set(_CMAKE_COMPILE_AS_CCE_FLAG "--cce-aicore-arch=dav-m300-vec")
        endif()
        set(_CMAKE_CCE_COMPILE_OPTIONS
            "-mllvm -cce-aicore-function-stack-size=16000 -mllvm -cce-aicore-fp-ceiling=2 -mllvm -cce-aicore-record-overflow=false")
...
elseif(ASCEND_RUN_MODE STREQUAL "sim")
    ...
    if(ASCEND_PRODUCT_TYPE STREQUAL "Ascend910A")
