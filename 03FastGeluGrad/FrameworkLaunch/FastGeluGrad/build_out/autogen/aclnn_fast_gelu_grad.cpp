...
[[maybe_unused]] uint32_t NNOPBASE_FastGeluGrad = 0U;
} // namespace
    ...
    aclOpExecutor **executor)
{
    ...
    static NnopbaseDfxId tilingId = {0x60000, "aclnnFastGeluGradTiling", false};
    void *nnopExecutor;
    static void *executorSpace = NULL;
    const char *opType = "FastGeluGrad";
    char inputDesc[] = {1, 1};
    char outputDesc[] = {1};
    char attrDesc[] = {};

    NNOPBASE_ASSERT_NOTNULL_RETVAL(dy);
    ...
    *executor = reinterpret_cast<aclOpExecutor *>(nnopExecutor);
    ...
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddInput(*executor, dy, 0));
